...
tags:
  ...
  - About Me
gallery:
  - url: /assets/images/legacy/walkthrough/13-data-protection_orig.png
    image_path: /assets/images/legacy/walkthrough/13-data-protection_th.png
    alt: "Data Protection Settings"
    title: "Data Protection Settings"
  - url: //assets/images/legacy/walkthrough/14-access-reqs_orig.png
    image_path: /assets/images/legacy/walkthrough/14-access-reqs_th.png
    alt: "Access Requirements"
    title: "Access Requirements"
  - url: /assets/images/legacy/walkthrough/15-conditional-launch.png
    image_path: /assets/images/legacy/walkthrough/15-conditional-th.png
...
![Guided Scenario Overview page](/assets/images/legacy/walkthrough/01-overview_orig.png "Overview")
...
![Guided Scenario Card](/assets/images/legacy/walkthrough/02-card.png "Secure Office Apps for Mobile Card")
...
![Secure Office Mobile Introduction](/assets/images/legacy/walkthrough/03-intro.png "Secure Office Apps for Mobile Introduction")
___
...
![Navigation Breadcrumbs](/assets/images/legacy/walkthrough/04-breadcrumb_orig.png "Navigation Breadcrumbs")
___
...
![Mobile Apps Basics](/assets/images/legacy/walkthrough/05-basics.png "Mobile Apps Basic Information")
___
...
![Mobile Apps Baseline Applications](/assets/images/legacy/walkthrough/06-apps.png "Mobile Apps Baseline")
___
...
[Selecting Mobile Apps](/assets/images/legacy/walkthrough/07-targeted-apps.png "Selecting Additional Applications")
___
...
![Details Help Flyout](/assets/images/legacy/walkthrough/08-details-flyout.png "Help test on a flyout")
___
...
![App Protection Settings](/assets/images/legacy/walkthrough/09-configuration.png "App Protection Settings Configuration")
___
...
![Policy Assignment](/assets/images/legacy/walkthrough/10-assignments.png "Assigning App Protection Policies")
___
...
![Review and Create settings](/assets/images/legacy/walkthrough/11-review.png "Review and create policy settings")
___
...
![Guided scenario confirmation page](/assets/images/legacy/walkthrough/12-confirmation.png "Confirming configured policies")
___
